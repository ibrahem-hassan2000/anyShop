...
function HeaderNav () {
 ...
 <Link to='/SignUp' className=' right-[110px] md:right-[50px] shopIcon '>  <Avatar radius="xl" className='block m-auto' src={userInfo? userInfo.image: img1}/> {userInfo&&<h3 className='text-[8px] font-bold text-center'>{userInfo.name}</h3>} </Link>  
